...
%
  dim_num = 2;
  file_out_name = 'uniform_on_sphere01_map.txt';
  n = 50;
  seed = 123456789;

  fprintf ( 1, '\n' );
  fprintf ( 1, 'TEST26\n' );
  fprintf ( 1, '  UNIFORM_ON_SPHERE01_MAP maps uniform\n' );
  fprintf ( 1, '  points onto the unit sphere.\n' );
  fprintf ( 1, '\n' );
