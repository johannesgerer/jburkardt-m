...
%
  dim_num = 2;
  file_out_name = 'uniform_in_cube01.txt';
  n = 1000;
  seed = 123456789;

  fprintf ( 1, '\n' );
  fprintf ( 1, 'TEST14\n' );
  fprintf ( 1, '  UNIFORM_IN_CUBE01 generates uniform \n' );
  fprintf ( 1, '  points in the unit hypercube.\n' );
  fprintf ( 1, '\n' );
  fprintf ( 1, '  Spatial dimension DIM_NUM =   %12d\n', dim_num );
  fprintf ( 1, '  Number of points N =          %12d\n', n );
  fprintf ( 1, '  Initial random number SEED =  %12d\n', seed );

  [ x, seed ] = uniform_in_cube01 ( dim_num, n, seed );
