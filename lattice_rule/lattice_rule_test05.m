function lattice_rule_test05 ( )

%*****************************************************************************80
%
%% LATTICE_RULE_TEST05 tests FIBONACCI_LATTICE_Q2;
%
%  Licensing:
%
...
%
  ...
  fprintf ( 1, '\n' );
  fprintf ( 1, 'LATTICE_RULE_TEST05\n' );
  fprintf ( 1, '  FIBONACCI_LATTICE_Q2 applies a Fibonacci lattice rule\n' );
