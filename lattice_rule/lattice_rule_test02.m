function lattice_rule_test02 ( )

%*****************************************************************************80
%
%% LATTICE_RULE_TEST02 tests FIBONACCI_LATTICE_T;
%
%  Licensing:
%
...
%
  ...
  fprintf ( 1, '\n' );
  fprintf ( 1, 'LATTICE_RULE_TEST02\n' );
  fprintf ( 1, '  FIBONACCI_LATTICE_T applies a \n' );
  fprintf ( 1, '\n' );
  fprintf ( 1, '  symmetric Fibonacci lattice rule\n' );
  fprintf ( 1, '  ---------\n' );
  fprintf ( 1, '\n' );
