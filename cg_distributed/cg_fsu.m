%% CG_FSU uses the fsuClusterMatlab command to run the CG computation.
%
%  Discussion:
%
...
%    @cg_fun indicates the function we want to execute;
%    {} would contain input arguments if there were any.
%
%    The function "cg_fun" must correspond to a MATLAB M-file "cg_fun.m"
