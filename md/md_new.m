function md_new ( nd, np, step_num, dt )

%*****************************************************************************80
%
%% MD_NEW is the main program for the molecular dynamics simulation.
%
%  Discussion:
%
%    MD_NEW is a modification of the MD code.
%
%    The compute() function used in MD has been replaced by a compute_new()
%    function which takes advantage of some of MATLAB's vector capabilities.
%    It is hoped that MD_NEW will execute faster than MD does.
%
%    Like MD, MD_NEW implements a simple molecular dynamics simulation.
%
...
%  Discussion:
%
%    This is a modified version of the compute function.  It has been rewritten
%    in an attempt to speed it up, by taking advantage of MATLAB's vector
%    capabilities.
%
