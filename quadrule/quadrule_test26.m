...
%
  ...
  fprintf ( 1, '\n' );
  fprintf ( 1, 'TEST26\n' );
  fprintf ( 1, '  LEGENDRE_SET_COS2 sets up Gauss-Legendre quadrature\n' );
  fprintf ( 1, '    over [0,PI/2] with weight function COS(X);\n' );
  ...
  for ilo = 1 : 5 : nfunc
    ...
    for iexp = 1 : 4
      ...
      for i = ilo : ihi
        ...
        [ xtab, weight ] = legendre_set_cos2 ( norder );
