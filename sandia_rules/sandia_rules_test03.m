function sandia_rules_test03 ( )

%*****************************************************************************80
%
%% SANDIA_RULES_TEST03 tests CHEBYSHEV2_COMPUTE against CHEBYSHEV2_INTEGRAL.
%
%  Licensing:
%
...
%
  ...
  fprintf ( 1, '\n' );
  fprintf ( 1, 'SANDIA_RULES_TEST03\n' );
  fprintf ( 1, '  CHEBYSHEV2_COMPUTE computes a Gauss-Chebyshev type 2 rule\n' );
  fprintf ( 1, '  which is appropriate for integrands of the form\n' );
  fprintf ( 1, '    Integral ( 0 <= x < +oo ) f(x) * sqrt ( 1 - x^2 ) dx.\n' );
  fprintf ( 1, '\n' );
  fprintf ( 1, '  CHEBYSHEV2_INTEGRAL determines the exact value of\n' );
