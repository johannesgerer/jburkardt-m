function sandia_rules_test19 ( )

%*****************************************************************************80
%
%% SANDIA_RULES_TEST19 tests LAGUERRE_COMPUTE against LAGUERRE_INTEGRAL.
%
%  Licensing:
%
...
%
  ...
  fprintf ( 1, '\n' );
  fprintf ( 1, 'SANDIA_RULES_TEST19\n' );
  fprintf ( 1, '  LAGUERRE_COMPUTE computes a Gauss-Laguerre rule\n' );
  fprintf ( 1, '  which is appropriate for integrands of the form\n' );
  fprintf ( 1, '    Integral ( 0 <= x < +oo ) f(x) exp(-x) dx.\n' );
  fprintf ( 1, '\n' );
  fprintf ( 1, '  LAGUERRE_INTEGRAL determines the exact value of\n' );
