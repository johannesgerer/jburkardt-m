...
%*****************************************************************************80
%
%% BTI_TEST05 tests BURGERS_TIME_INVISCID.
%
%  Licensing:
%
...
%
  ...
  xlabel ( '<-- X -->' )
  ylabel ( '<-- U(X,T) -->' )
  title ( 'Burgers, inviscid, initial expansion, McCormack' )

  filename = 'bti_test05.png';
  print ( '-dpng', filename )
  fprintf ( 1, '\n' );
