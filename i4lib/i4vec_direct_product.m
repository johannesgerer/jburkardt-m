function x = i4vec_direct_product ( factor_index, factor_order, ...
...
%
%    Input, integer FACTOR_VALUE(FACTOR_ORDER), the factor values for
%    factor FACTOR_INDEX.
%
...
%
%    Input, integer X(FACTOR_NUM,POINT_NUM), the elements of the
%    direct product, which are built up gradually. 
%
%    Output, integer X(FACTOR_NUM,POINT_NUM), the elements of the
