...
%
  ...
  fprintf ( 1, '  I4VEC_INSERT inserts a value into a vector.\n' );
  fprintf ( 1, '\n' );
  fprintf ( 1, '  We use these two routines to bracket a value,\n' );
  fprintf ( 1, '  and then insert it.\n' );
