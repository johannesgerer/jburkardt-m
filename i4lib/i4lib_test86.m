...
%
  fprintf ( 1, '\n' );
  fprintf ( 1, 'I4LIB_TEST86\n' );
  fprintf ( 1, '  I4VEC_UNDEX produces index vectors which create a sorted\n' );
  fprintf ( 1, '  list of the unique elements of an (unsorted) I4VEC, \n' );
  fprintf ( 1, '  and a map from the original vector to the (implicit) \n' );
  fprintf ( 1, '  vector of sorted unique elements.\n' );

  x_num = 9;
  x_val = [ 33, 55, 11, 11, 55, 33, 22, 22, 11 ];
  ...
  [ undx, xdnu ] = i4vec_undex ( x_num, x_val, x_unique_num );
