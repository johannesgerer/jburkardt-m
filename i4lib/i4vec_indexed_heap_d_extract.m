function [ indx_extract, n, indx ] = i4vec_indexed_heap_d_extract ( n, a, indx )
...
%
%    Output, integer N, the number of items in the
%    revised index vector.
%
%    Output, integer INDX(N), the revised index vector.
%
  if ( n < 1 )
    fprintf ( 1, '\n' );
    fprintf ( 1, 'I4VEC_INDEXED_HEAP_D_EXTRACT - Fatal error!\n' );
    fprintf ( 1, '  The heap is empty.\n' );
    error ( 'I4VEC_INDEXED_HEAP_D_EXTRACT - Fatal error!' )
  end
%
