function sgmga_size_test ( dim_num, importance, level_weight, ...
...
%
  fprintf ( 1, '\n' );
  fprintf ( 1, 'SGMGA_SIZE_TOTAL_TEST\n' );
  fprintf ( 1, '  SGMGA_SIZE_TOTAL counts the total number of points,\n' );
  fprintf ( 1, '  including duplications, in an SGMGA sparse grid.\n' );
  fprintf ( 1, '  SGMGA_SIZE counts the total number of points,\n' );
  fprintf ( 1, '  excluding duplications, in an SGMGA sparse grid.\n' );
  fprintf ( 1, '\n' );
  ...
  fprintf ( 1, '\n' );
  fprintf ( 1, '   DIM_NUM LEVEL_MAX Point_num Point_Num\n' );
