function sgmga_point_test ( dim_num, importance, level_weight, ...
...
%
%    Input, real IMPORTANCE(DIM_NUM), the importance of each dimension.
%
...
%
  fprintf ( 1, '\n' );
  fprintf ( 1, 'SGMGA_POINT_TEST\n' );
  fprintf ( 1, '  SGMGA_POINT returns an array of the points\n' );
  fprintf ( 1, '  forming a multidimensional sparse grid with mixed factors.\n' );
  fprintf ( 1, '\n' );
