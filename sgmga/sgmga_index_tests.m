function sgmga_index_tests ( )

%****************************************************************************80
%
%% SGMGA_INDEX_TESTS calls SGMGA_INDEX_TEST with various arguments.
%
%  Licensing:
%
...
%
  ...
  fprintf ( 1, '\n' );
  fprintf ( 1, 'SGMGA_INDEX_TESTS\n' );
  fprintf ( 1, '  Call SGMGA_INDEX_TEST with various arguments.\n' );
%
