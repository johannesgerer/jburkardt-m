...
%
  ...
  fprintf ( 1, '\n' );
  fprintf ( 1, 'SGMGA_SIZE_TESTS\n' );
  fprintf ( 1, '  Call SGMGA_SIZE_TEST.\n' );
%
%  Set the point equality tolerance.
%
  tol = sqrt ( eps );
  fprintf ( 1, '\n' );
  fprintf ( 1, '  Point equality tolerance = %e.\n', tol );
  ...
  sgmga_size_test ( dim_num, importance, level_weight, level_max_min, ...
    level_max_max, rule, growth, np, p, tol );
%
%  Look at a case with a dimension of "0" importance.
%
  dim_num = 3;
