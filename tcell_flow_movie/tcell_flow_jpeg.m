function tcell_flow_jpeg ( )

%*****************************************************************************80
%
%% TCELL_FLOW_JPEG makes JPEG images of the TCELL data.
%
%  Discussion:
%
...
%  All the velocity files wiill have this format, with the
