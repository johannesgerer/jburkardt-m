function int_exactness_laguerre ( quad_filename, degree_max, option )

%*****************************************************************************80
%
%% MAIN is the main program for INT_EXACTNESS_LAGUERRE.
%
%  Discussion:
%
...
%
  timestamp (  );
  fprintf ( 1, '\n' );
  fprintf ( 1, 'INT_EXACTNESS_LAGUERRE\n' );
  fprintf ( 1, '  MATLAB version\n' );
  fprintf ( 1, '\n' );
  fprintf ( 1, '  Investigate the polynomial exactness of a Gauss-Laguerre\n' );
...
%
  fprintf ( 1, '\n' );
  fprintf ( 1, 'INT_EXACTNESS_LAGUERRE: User input:\n' );
...
%
  ...
  fprintf ( 1, '  a Gauss-Laguerre rule\n' );
  fprintf ( 1, '  ORDER = %d\n', order );
  fprintf ( 1, '  A = %f\n', a );
  fprintf ( 1, '\n' );
  if ( option == 0 )
    fprintf ( 1, '  OPTION = 0, standard rule:\n' );
    fprintf ( 1, '    Integral ( A <= x < oo ) exp(-x) f(x) dx\n' );
...
%
  ...
  for degree = 0 : degree_max
    ...
    quad_error = monomial_quadrature_laguerre ( degree, order, option, w, x );
...
function quad_error = monomial_quadrature_laguerre ( expon, order, option, w, x )

%*****************************************************************************80
%
%% MONOMIAL_QUADRATURE_LAGUERRE applies a quadrature rule to a monomial.
%
%  Licensing:
%
%    This code is distributed under the GNU LGPL license.
