function [ w, xyz ] = hexa_unit_rule ( order_1d )
...
%
  ...
  for dim = 1 : dim_num
    ...
    elseif ( order_1d(dim) == 5 )
      ...
      fprintf ( 1, '\n' );
      fprintf ( 1, 'HEXA_UNIT_RULE - Fatal error!\n' );
      fprintf ( 1, '  Illegal value of ORDER_1D(*).\n' );
      error ( 'HEXA_UNIT_RULE - Fatal error!' );
    end

    xyz = r8vec_direct_product ( dim, order_1d(dim), x_1d, ...
      dim_num, order, xyz );
