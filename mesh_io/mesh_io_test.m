function mesh_io_test ( )

%*****************************************************************************80
%
%% MESH_IO_TEST tests the MESH_IO library.
%
%  Licensing:
%
...
%
  timestamp ( );
  fprintf ( 1, '\n' );
  fprintf ( 1, 'MESH_IO_TEST\n' );
  fprintf ( 1, '  MATLAB version\n' );
  fprintf ( 1, '  Test the MESH_IO library.\n' );
%
