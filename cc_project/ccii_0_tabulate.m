function ccii_0_tabulate ( )

%*****************************************************************************80
%
%% CCII_0_TABULATE tabulates CCII_0 quadrature rules for the Hermite integral.
%
%  Licensing:
%
...
%
  fprintf ( 1, '\n' );
  fprintf ( 1, 'CCII_0_TABULATE\n' );
  fprintf ( 1, '  Tabulate CCII_0 quadrature rules for the Hermite integral.\n' );
