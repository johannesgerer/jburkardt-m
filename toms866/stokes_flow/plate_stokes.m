...
gohome
cd datafiles
save plate_stokes_nobc pde domain qmethod stretch A B Q f g xy xyp mbound bound x y 
save plate_stokes_nobc Bx By  -append
if qmethod==1 
   save plate_stokes_nobc C G ev ee ebound -append
elseif qmethod==0 
   save plate_stokes_nobc C G ev ee ebound mv enclosed -append
elseif qmethod==2
   save plate_stokes_nobc G mv mp -append
else
   save plate_stokes_nobc G mv ee -append
end
