function [error_x,error_y] = stokespost_q1p0_bc(aez,fezx,fezy,elerrorx,elerrory,xy,ev,ebound);
%stokespost_q1p0_bc   postprocesses Poisson error estimator 
%   [error_x,error_y] = stokespost_q1p0_bc(aez,fezx,fezy,elerrorx,elerrory,xy,ev,ebound);;
%   input
