...
longstep_domain(outbnd); domain = 3;
load step_grid
%
%% set up matrices
...
gohome
cd datafiles
save step_stokes_nobc pde domain outbnd qmethod stretch A B Q f g xy xyp mbound bound x y 
save step_stokes_nobc Bx By  -append
if qmethod==1 
   save step_stokes_nobc C G ev ee ebound -append
elseif qmethod==0 
   save step_stokes_nobc C G ev ee ebound mv enclosed -append
elseif qmethod==2
   save step_stokes_nobc G mv mp -append
else
   save step_stokes_nobc G ee mv  -append
end
