%% COLLATZ_FSU uses the fsuClusterMatlab command to run the COLLATZ computation.
%
%  Discussion:
%
...
%    @collatz_fun indicates the function we want to execute;
%    {} would contain input arguments if there were any.
%
%    The function "collatz_fun" must correspond to a MATLAB M-file "collatz_fun.m"
...
%    John Burkardt
%
  fsuClusterMatlab ( [], [], 'p', 'w', 4, @collatz_fun, { 10000000 } )
