function p_xy = cvt_disk_interior ( r, ns, np, p_xy, p_type )

%*****************************************************************************80
%
%% CVT_DISK_INTERIOR computes a CVT in the disk interior.
%
%  Licensing:
%
...
%
%  Only update the positions of points in the interior.
%
    p_xy(1:2,i) = v_xy(1:2,i);
