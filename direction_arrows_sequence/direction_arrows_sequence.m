function direction_arrows_sequence ( xy_filename, uv_filename, scale )

%*****************************************************************************80
%
%% DIRECTION_ARROWS_SEQUENCE creates velocity direction plots from a sequence of datasets.
%
%  Discussion:
%
...
%  Usage:
%
%    direction_arrows_sequence ( xy_filename, uv_filename, scale )
%
%    Note that a literal filename must be enclosed in single quotes.
%    Thus, a typical invocation might be
%
%      direction_arrows_sequence ( 'xy.txt', 'u0001.txt', 1.0 )
%
...
%
  timestamp ( );
  fprintf ( 1, '\n' );
  fprintf ( 1, 'DIRECTION_ARROWS_SEQUENCE:\n' );
  fprintf ( 1, '  Given one XY file, and a sequence of UV files,\n' );
  fprintf ( 1, '  display the velocity direction fields\n' );
...
%
  ...
  if ( ~file_exist ( xy_filename ) )
    fprintf ( 1, '\n' );
    fprintf ( 1, 'DIRECTION_ARROWS_SEQUENCE - Fatal error!\n' );
...
%
  ...
  if ( node_num < 1 ) 
    ...
    error ( 'DIRECTION_ARROWS_SEQUENCE - Fatal error!' );
  end
%
