...
%
  ...
  if ( abs ( q ) <= split1 )
    ...
    r = const1 - q * q;
    value = q * r8poly_val_horner ( 8, a, r ) / r8poly_val_horner ( 8, b, r );
    ...
    if ( r <= split2 )
      ...
      r = r - const2;
      value = r8poly_val_horner ( 8, c, r ) / r8poly_val_horner ( 8, d, r );

     else

       r = r - split2;
       value = r8poly_val_horner ( 8, e, r ) / r8poly_val_horner ( 8, f, r );
