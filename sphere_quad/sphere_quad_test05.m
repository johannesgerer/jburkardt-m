function sphere_quad_test05 ( )

%*****************************************************************************80
%
%% SPHERE_QUAD_TEST05 tests SPHERE01_QUAD_ICOS2V.
%
%  Licensing:
%
...
%
  fprintf ( 1, '\n' );
  fprintf ( 1, 'SPHERE_QUAD_TEST05\n' );
  fprintf ( 1, '  Approximate the integral of a function on the unit sphere.\n' );
  fprintf ( 1, '  SPHERE01_QUAD_ICOS2V uses vertices of spherical triangles.\n' );
  fprintf ( 1, '\n' );
  ...
  for i = 1 : 17
    ...
    for factor_log = 0 : 5
      ...
      [ result, n ] = sphere01_quad_icos2v ( factor, @polyterm_value_3d );
