function [ result, node_num ] = sphere01_quad_icos2v ( factor, fun )
...
%
  for face = 1 : face_num
    ...
    a_xyz(1:3,1) = point_coord(1:3,a);
    b_xyz(1:3,1) = point_coord(1:3,b);
    c_xyz(1:3,1) = point_coord(1:3,c);
%
...
%
    for f1 = 0 : factor - 1
      for f2 = 0 : factor - f1 - 1
        ...
        a2_xyz = sphere01_triangle_project2 ( ...
          a_xyz, b_xyz, c_xyz, f1 + 1, f2,     f3 - 1 );
        b2_xyz = sphere01_triangle_project2 ( ...
          a_xyz, b_xyz, c_xyz, f1,     f2 + 1, f3 - 1 );
        c2_xyz = sphere01_triangle_project2 ( ...
