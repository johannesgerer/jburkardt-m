function [ result, node_num ] = sphere01_quad_icos1c ( factor, fun )
    ...
    for f3 = 1 : 3 : 3 * factor - 2
      for f2 = 1 : 3 : 3 * factor - f3 - 1
        ...
        a2_xyz = sphere01_triangle_project ( ...
          a_xyz, b_xyz, c_xyz, f1 + 2, f2 - 1, f3 - 1 );
        b2_xyz = sphere01_triangle_project ( ...
          a_xyz, b_xyz, c_xyz, f1 - 1, f2 + 2, f3 - 1 );
        c2_xyz = sphere01_triangle_project ( ...
          a_xyz, b_xyz, c_xyz, f1 - 1, f2 - 1, f3 + 2 );
