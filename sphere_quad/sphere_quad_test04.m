function sphere_quad_test04 ( )

%*****************************************************************************80
%
%% SPHERE_QUAD_TEST04 tests SPHERE01_QUAD_ICOS1V.
%
%  Licensing:
%
...
%
  fprintf ( 1, '\n' );
  fprintf ( 1, 'SPHERE_QUAD_TEST04\n' );
  fprintf ( 1, '  Approximate the integral of a function on the unit sphere.\n' );
  fprintf ( 1, '  SPHERE01_QUAD_ICOS1V uses vertices of spherical triangles.\n' );
  fprintf ( 1, '\n' );
  ...
  for i = 1 : 17
    ...
    for factor_log = 0 : 5
      ...
      [ result, n ] = sphere01_quad_icos1v ( factor, @polyterm_value_3d );
