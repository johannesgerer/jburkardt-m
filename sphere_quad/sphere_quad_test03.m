function sphere_quad_test03 ( )

%*****************************************************************************80
%
%% SPHERE_QUAD_TEST03 tests SPHERE01_QUAD_ICOS1M.
%
%  Licensing:
%
...
%
  fprintf ( 1, '\n' );
  fprintf ( 1, 'SPHERE_QUAD_TEST03\n' );
  fprintf ( 1, '  Approximate the integral of a function on the unit sphere.\n' );
  fprintf ( 1, '  SPHERE01_QUAD_ICOS1M uses midpoints of spherical triangles.\n' );
  fprintf ( 1, '\n' );
  ...
  for i = 1 : 17
    ...
    for factor_log = 0 : 5
      ...
      [ result, n ] = sphere01_quad_icos1m ( factor, @polyterm_value_3d );
