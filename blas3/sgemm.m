function c = sgemm ( transa, transb, m, n, k, alpha, a, lda, b, ldb, beta, ...
  c, ldc )
...
%
  ...
  if ( ~ ( transa == 'N' || transa == 'n' || ...
           ...
           transa == 'T' || transa == 't' ) )
    info = 1;
    fprintf ( 1, 'SGEMM rejects input argument number %d\n', info );
    error ( 'SGEMM - Fatal error!' );
  end
