function tetrahedron_monte_carlo_test07 ( )

%*****************************************************************************80
%
%% TETRAHEDRON_MONTE_CARLO_TEST07 uses TETRAHEDRON_SAMPLE_03 on a general tetrahedron.
%
%  Licensing:
%
...
%
  ...
  fprintf ( 1, '\n' );
  fprintf ( 1, 'TETRAHEDRON_MONTE_CARLO_TEST07\n' );
