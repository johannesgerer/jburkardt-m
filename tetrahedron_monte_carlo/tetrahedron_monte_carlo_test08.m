function tetrahedron_monte_carlo_test08 ( )

%*****************************************************************************80
%
%% TETRAHEDRON_MONTE_CARLO_TEST08 uses TETRAHEDRON_SAMPLE_04 on a general tetrahedron.
%
%  Licensing:
%
...
%
  ...
  fprintf ( 1, '\n' );
  fprintf ( 1, 'TETRAHEDRON_MONTE_CARLO_TEST08\n' );
