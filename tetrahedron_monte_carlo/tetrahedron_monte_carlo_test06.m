function tetrahedron_monte_carlo_test06 ( )

%*****************************************************************************80
%
%% TETRAHEDRON_MONTE_CARLO_TEST06 uses TETRAHEDRON_SAMPLE_02 on a general tetrahedron.
%
%  Licensing:
%
...
%
  ...
  fprintf ( 1, '\n' );
  fprintf ( 1, 'TETRAHEDRON_MONTE_CARLO_TEST06\n' );
  fprintf ( 1, '  Sample using TETRAHEDRON_UNIT_SAMPLE_02\n' );
