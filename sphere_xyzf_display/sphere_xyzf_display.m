...
%*****************************************************************************80
%
%% SPHERE_XYZF_DISPLAY displays points and faces on the unit sphere.
%
%  Discussion:
%
%    Mainly, this program inserts a unit sphere into the viewing field,
%    and then "decorates" it with the points and faces.
%
%    The points should lie on the unit sphere; the faces will appear
%    properly as long as they are small enough that the lines forming
%    their edges don't cut into the sphere and disappear.
%
%  Licensing:
%
...
%
  ...
  fprintf ( 1, '\n' );
  fprintf ( 1, '  We assume the points and faces lie on the unit sphere.\n' );
  fprintf ( 1, '\n' );
  fprintf ( 1, '  Display the sphere, the points and the faces.\n' );
%
...
%
%  Read the XYZ data.
%  We could have used LOAD instead, but I wanted to allow '#' comments in
%  the input files.  Now that seems an expensive luxury.
%
