function [ r, seed, it_diff, energy ] = cvt_iterate ( ndim, n, batch, sample, ...
...
%
%    Input, real R(NDIM,N), the Voronoi cell generators.
%
%    Output, real R(NDIM,N), the updated Voronoi cell generators.
%
...
%
  ...
  while ( have < sample_num )
    ...
    [ s, seed ] = cvt_sample ( ndim, sample_num, get, sample, initialize, ...
      seed );
...
%
    nearest = find_closest ( ndim, n, get, s, r );
%
...
%
  it_diff = 0.0;
  for j = 1 : n
    it_diff = it_diff + sqrt ( sum ( ( r2(1:ndim,j) - r(1:ndim,j) ).^2 ) );
  end
%
