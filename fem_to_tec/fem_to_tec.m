function fem_to_tec ( prefix )

%*****************************************************************************80
%
%% FEM_TO_TEC converts an FEM model into a TECPLOT ASCII file.
%
%  Usage:
%
%    fem_to_tec ( 'prefix' )
...
%
%    reads the data from these files, and creates an equivalent TECPLOT
%    ASCII file named 'prefix'.dat
%
%  Licensing:
%
...
%
  ...
  fprintf ( 1, '\n' );
  fprintf ( 1, 'FEM_TO_TEC:\n' );
  fprintf ( 1, '  MATLAB version\n' );
  fprintf ( 1, '\n' );
  fprintf ( 1, '  Read an FEM model consisting of:\n' );
  fprintf ( 1, '  * a nodes file,\n' );
  fprintf ( 1, '  * an elements file,\n' );
  fprintf ( 1, '  * a values file;\n' );
  fprintf ( 1, '\n' );
