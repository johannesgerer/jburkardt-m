%% CONTRAST_FSU uses the fsuClusterMatlab command to run the CONTRAST computation.
%
%  Discussion:
%
...
%    @contrast_fun indicates the function we want to execute;
%    {} would contain input arguments if there were any.
%
%    The function "contrast_fun" must correspond to a MATLAB M-file "contrast_fun.m"
...
%
  ...
  fsuClusterMatlab ( [], [], 'm', 'w', 4, @contrast_fun, { x } )
