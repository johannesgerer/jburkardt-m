function kmeans_test02 ( )

%*****************************************************************************80
%
%% KMEANS_TEST02 tries out the HMEANS_02 routine.
%
%  Licensing:
%
...
%    John Burkardt
%
  center_filename = 'test02_centers.txt';
  cluster_filename = 'test02_clusters.txt';
  point_filename = 'points_100.txt';

  fprintf ( 1, '\n' );
  fprintf ( 1, 'KMEANS_TEST02\n' );
  fprintf ( 1, '  Test the HMEANS_02 algorithm.\n' );
%
...
%
  ...
  [ cluster, cluster_center, cluster_population, cluster_energy, it_num, ...
    seed ] = hmeans_02 ( dim_num, point_num, cluster_num, it_max, ...
