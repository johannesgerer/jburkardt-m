function nco_triangle_test04 ( )

%*****************************************************************************80
%
%% TEST04 tests NCO_TRIANGLE_RULE.
%
%  Licensing:
%
...
%
  fprintf ( 1, '\n' );
  fprintf ( 1, 'TEST04\n' );
  fprintf ( 1, '  NCO_TRIANGLE_RULE returns the points and weights of\n' );
  fprintf ( 1, '  an NCO rule for the unit triangle.\n' );
  fprintf ( 1, '\n' );
