function [ xy, w ] = nco_triangle_rule ( rule, order_num )
...
%
  ...
  [ suborder_xyz, suborder_w ] = nco_triangle_subrule ( rule, suborder_num );
%
...
%
  ...
  for s = 1 : suborder_num
    ...
    elseif ( suborder(s) == 6 )
      ...
      fprintf ( 1, '\n' );
      fprintf ( 1, 'NCO_TRIANGLE_RULE - Fatal error!\n' );
      fprintf ( 1, '  Illegal SUBORDER(%d) = %d\n', s, suborder(s) );
      error ( 'NCO_TRIANGLE_RULE - Fatal error!' );
