function int_exactness_legendre ( quad_filename, degree_max )
...
%
  timestamp (  );
  fprintf ( 1, '\n' );
  fprintf ( 1, 'INT_EXACTNESS_LEGENDRE\n' );
...
%
  fprintf ( 1, '\n' );
  fprintf ( 1, 'INT_EXACTNESS_LEGENDRE: User input:\n' );
...
%
  ...
  for degree = 0 : degree_max
    ...
    quad_error = monomial_quadrature_legendre ( degree, order, w, x );

    quad_error2 = monomial_quadrature_legendre ( degree, order, w2, x2 );
...
function quad_error = monomial_quadrature_legendre ( expon, order, w, x )
