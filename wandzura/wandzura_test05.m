function wandzura_test05 ( )

%*****************************************************************************80
%
%% WANDZURA_TEST05 plots the Wandzura points in the unit triangle.
%
%  Licensing:
%
...
%
  ...
  fprintf ( 1, '\n' );
  fprintf ( 1, 'WANDZURA_TEST05\n' );
  fprintf ( 1, '  This routine creates an EPS plot of each\n' );
  fprintf ( 1, '  set of Wandzura points.\n' );
  fprintf ( 1, '\n' );

  rule_num = wandzura_rule_num ( );

  file_name = 'wandzura_rule_0.eps';
