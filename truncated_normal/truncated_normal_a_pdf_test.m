function truncated_normal_a_pdf_test ( )
...
%
  fprintf ( 1, '\n' );
  fprintf ( 1, 'TRUNCATED_NORMAL_A_PDF_TEST\n' );
  fprintf ( 1, '  TRUNCATED_NORMAL_A_PDF evaluates the lower Truncated Normal PDF.\n' );
  fprintf ( 1, '\n' );
