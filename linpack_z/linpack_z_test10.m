...
%
  ...
  fprintf ( 1, '  ZGTSL solves a linear system.\n' );
  fprintf ( 1, '\n' );
...
%
  ...
  c(1) = 0.0;
  [ c(2:n), seed ] = c8vec_uniform_01 ( n-1, seed );

  [ e(1:n-1), seed ] = c8vec_uniform_01 ( n-1, seed );
  e(n) = 0.0;
