...
%
  ...
  fprintf ( 1, '  ZQRDC computes the QR decomposition of a \n' );
  ...
  fprintf ( 1, '\n' );
  fprintf ( 1, '  Show how Q and R can be recovered using ZQRSL.\n' );
%
%  Set the values of the matrix A.
%
  seed = 123456789;

  [ a, seed ] = c8mat_uniform_01 ( n, p, seed );
...
%
  ...
  [ a, qraux, ipvt ] = zqrdc ( a, lda, n, p, ipvt, job );
%
...
%
    [ qy, qty, b, rsd, xb, info ] = zqrsl ( a, lda, n, p, qraux, y, job );

    if ( info ~= 0 )
      fprintf ( 1, '  Error!  ZQRSL returns INFO = %d\n', info );
      return
    end
%
