function value = p17_param ( action, name, value )

%*****************************************************************************80
%
%% P17_PARAM defaults, sets, or gets the parameters for problem 17.
%
%  Discussion:
%
...
%      value = p17_param ( 'GET', 'DELTA' )
%    or set to a new value, as in:
%      p17_param ( 'SET', 'DELTA', 7 )
%
...
%
  ...
  elseif ( s_eqi ( action, 'SET' ) )
    ...
    if ( s_eqi ( name, 'DELTA' ) )
      ...
      fprintf ( 1, '\n' );
      fprintf ( 1, 'P17_PARAM - Fatal error!\n' );
      fprintf ( 1, '  Unrecognized variable name: "%s".\n', name );
      error ( 'P17_PARAM - Fatal error!' );
    end
