function value = p19_param ( action, name, value )

%*****************************************************************************80
%
%% P19_PARAM defaults, sets, or gets the parameters for problem 19.
%
%  Discussion:
%
...
%      value = p19_param ( 'GET', 'DELTA' )
%    or set to a new value, as in:
%      p19_param ( 'SET', 'DELTA', 7 )
%
...
%
  ...
  elseif ( s_eqi ( action, 'SET' ) )
    ...
    if ( s_eqi ( name, 'DELTA' ) )
      ...
      fprintf ( 1, '\n' );
      fprintf ( 1, 'P19_PARAM - Fatal error!\n' );
      fprintf ( 1, '  Unrecognized variable name: "%s".\n', name );
      error ( 'P19_PARAM - Fatal error!' );
    end
