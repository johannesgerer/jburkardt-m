function value = p35_param ( action, name, value )

%*****************************************************************************80
%
%% P35_PARAM defaults, sets, or gets the parameters for problem 35.
%
%  Discussion:
%
...
%
  ...
  elseif ( s_eqi ( action, 'SET' ) )
    ...
    elseif ( s_eqi ( name, 'M' ) )
      ...
      fprintf ( 1, '\n' );
      fprintf ( 1, 'P35_PARAM - Fatal error!\n' );
      fprintf ( 1, '  Unrecognized variable name: "%s".\n', name );
      error ( 'P35_PARAM - Fatal error!' );
    end
