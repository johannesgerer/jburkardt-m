function sparse_grid_laguerre_test01 ( dim_min, dim_max, level_max_min, ...
  level_max_max )
...
%
  fprintf ( 1, '\n' );
  fprintf ( 1, 'TEST01\n' );
  fprintf ( 1, '  SPARSE_GRID_LAGUERRE_SIZE returns the number of distinct\n' );
  fprintf ( 1, '  points in a Gauss-Laguerre sparse grid.\n' );
  fprintf ( 1, '\n' );
  fprintf ( 1, '  Note that, unlike most sparse grids, a sparse grid\n' );
  fprintf ( 1, '  based on Gauss-Laguerre points is NOT nested. \n' );
  fprintf ( 1, '\n' );
