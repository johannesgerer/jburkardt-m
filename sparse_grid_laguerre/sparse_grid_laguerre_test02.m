...
%
  fprintf ( 1, '\n' );
  fprintf ( 1, 'TEST02:\n' );
  fprintf ( 1, '  SPARSE_GRID_LAGUERRE_INDEX returns abstract indexes for the\n' );
  fprintf ( 1, '  points that make up a Gauss-Laguerre sparse grid.\n' );
...
%  Compute the indices.
%
  [ grid_index, grid_base] = sparse_grid_laguerre_index ( dim_num, ...
    level_max, point_num );
%
%  Print the indices.
%
