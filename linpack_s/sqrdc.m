function [ a, qraux, jpvt ] = sqrdc ( a, lda, n, p, jpvt, job )
...
%  Parameters:
%
%    Input, real A(LDA,P), the N by P matrix whose decomposition 
%    is to be computed.
%
...
%
    ...
    if ( l ~= n )
      ...
      nrmxl = snrm2 ( n-l+1, a(l:n,l), 1 );

      if ( nrmxl ~= 0.0 )

        if ( a(l,l) ~= 0.0 )
          nrmxl = abs ( nrmxl ) * r4_sign ( a(l,l) );
        end
...
%
        for j = l + 1 : p
          ...
          t = -sdot ( n-l+1, a(l:n,l), 1, a(l:n,j), 1 ) / a(l,l);
          a(l:n,j) = saxpy ( n-l+1, t, a(l:n,l), 1, a(l:n,j), 1 );
