...
%
  ...
  fprintf ( 1, '  SSVDC computes the singular value decomposition:\n' );
  fprintf ( 1, '    A = U * S * V''\n' );
  fprintf ( 1, '\n' );
...
%
  ...
  [ a, seed ] = r4mat_uniform_01 ( m, n, seed );
...
%
  ...
  [ a, s, e, u, v, info ] = ssvdc ( a, lda, m, n, ldu, ldv, job );

  if ( info ~= 0 )
    fprintf ( 1, '\n' );
    fprintf ( 1, 'Warning:\n' );
    fprintf ( 1, '  SSVDC returned nonzero INFO = %d\n', info );
    return
  end
