function [ a, det ] = sgedi ( a, lda, n, ipvt, job )
...
%  Parameters:
%
%    Input, real A(LDA,N), the N by N factored matrix, as output by SGECO or SGEFA.
%
...
%
    for k = n-1 : -1 : 1
      ...
      for j = k+1 : n
        t = work(j);
        a(1:n,k) = saxpy ( n, t, a(1:n,j), 1, a(1:n,k), 1 );
      end

      l = ipvt(k);
      if ( l ~= k )
        [ a(1:n,k), a(1:n,l) ] = sswap ( n, a(1:n,k), 1, a(1:n,l), 1 );
      end
