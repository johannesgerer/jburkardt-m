function b = sgbsl ( abd, lda, n, ml, mu, ipvt, b, job )
  ...
  if ( job == 0 )
    ...
    if ( 0 < ml )
      ...
      for k = 1 : n-1
        ...
        b(k+1:k+lm) = saxpy ( lm, t, abd(m+1:m+lm,k), 1, b(k+1:k+lm), 1 );
      end
...
%
    for k = n : -1 : 1
      ...
      lb = k - lm;
      t = -b(k);
      b(lb:lb+lm-1) = saxpy ( lm, t, abd(la:la+lm-1,k), 1, b(lb:lb+lm-1), 1 );
    end
%
