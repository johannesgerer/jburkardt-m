...
%
  ...
  fprintf ( 1, '\n' );
  fprintf ( 1, 'TEST02\n' );
  fprintf ( 1, '  For ingle precision, general storage,\n' );
  fprintf ( 1, '  SCHEX can shift columns in a Cholesky factorization.\n' );
  fprintf ( 1, '\n' );
...
%
  ...
  job = 1;
  [ a, z, c, s ] = schex ( a, lda, n, k, l, z, n, nz, job );
%
...
%
  ...
  job = 2;
  [ a, z, c, s ] = schex ( a, lda, n, k+1, l, z, n, nz, job );
%
%  Print the factorization.
%
  fprintf ( 1, '\n' );
