function rbf_interp_nd_test03 ( )

%*****************************************************************************80
%
%% RBF_INTERP_ND_TEST03 tests RBF_WEIGHTS and RBF_INTERP_ND wiht PHI3.
%
%  Licensing:
%
...
%
  ...
  ylabel ( '<--- Y --->' );
  zlabel ( '<---Z(X,Y)--->' );
  title ( 'Radial Basis Interpolant using PHI3(R)' )
%
