function quality_test_sphere ( )

%*****************************************************************************80
%
%% QUALITY_TEST_SPHERE calls the QUALITY routines for points in the unit sphere.
%
%  Licensing:
%
...
%
  fprintf ( 1, '\n' );
  fprintf ( 1, 'QUALITY_TEST_SPHERE\n' );
  fprintf ( 1, '  Test the MATLAB QUALITY library\n' );
  fprintf ( 1, '  on points in the unit sphere.' );
  ...
  fprintf ( 1, '  The sample routine is SAMPLE_SPHERE_UNIFORM.\n' );
  fprintf ( 1, '\n' );
...
%
  ...
  quality_test01 ( dim_num, n, z, ns, 'sample_sphere_uniform', seed_init );
  quality_test02 ( dim_num, n, z, ns, 'sample_sphere_uniform', seed_init );
  quality_test03 ( dim_num, n, z, ns, 'sample_sphere_uniform', seed_init );
  quality_test04 ( dim_num, n, z );
  quality_test05 ( dim_num, n, z, ns, 'sample_sphere_uniform', seed_init );
  quality_test06 ( dim_num, n, z );
  quality_test07 ( dim_num, n, z, ns, 'sample_sphere_uniform', seed_init );
  quality_test08 ( dim_num, n, z, ns, 'sample_sphere_uniform', seed_init );
...
%
%  The SPHERE_MEASURE only makes sense for datasets in the unit hypercube.
%
% quality_test09 ( dim_num, n, z );

  quality_test10 ( dim_num, n, z, ns, 'sample_sphere_uniform', seed_init );
