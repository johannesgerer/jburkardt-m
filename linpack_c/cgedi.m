function [ a, det ] = cgedi ( a, lda, n, ipvt, job )
...
%  Parameters:
%
%    Input, complex A(LDA,N); the factor information from CGECO or CGEFA.  
%    
%    Input, integer LDA, the leading dimension of A.
%
%    Input, integer N, the order of the matrix.
%
%    Input, integer IPVT(N), the pivot vector from CGECO or CGEFA.
%
%    Input, integer JOB.
