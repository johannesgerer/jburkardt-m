...
%
  ...
  fprintf ( 1, '  CPBFA computes the LU factors.\n' );
  fprintf ( 1, '  CPBSL solves a factored linear system.\n' );
...
%
  ...
  [ a, info ] = cpbfa ( a, lda, n, m );

  if ( info ~= 0 )
    fprintf ( 1, '  Error!  CPBFA returns INFO = %d\n', info );
    return
  end
%
