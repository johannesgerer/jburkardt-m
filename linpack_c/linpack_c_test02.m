...
%
  ...
  fprintf ( 1, '  CCHEX can shift columns in a Cholesky factorization.\n' );
  fprintf ( 1, '\n' );
...
%
  ...
  [ a, ipvt, info ] = cchdc ( a, lda, n, ipvt, job );

  if ( info ~= n )
    fprintf ( 1, '\n' );
    fprintf ( 1, '  CCHDC returned INFO = %d\n', info );
...
%
  ...
  job = 1;
  [ a, z, c, s ] = cchex ( a, lda, n, k, l, z, ldz, nz, job );
%
