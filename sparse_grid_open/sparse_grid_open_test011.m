function sparse_grid_test011 ( dim_min, dim_max, level_max_min, ...
  level_max_max )
...
%
  fprintf ( 1, '\n' );
  fprintf ( 1, 'TEST011\n' );
  fprintf ( 1, '  SPARSE_GRID_ONN_SIZE returns the number of\n' );
  ...
  fprintf ( 1, '\n' );
  fprintf ( 1, '  For this kind of rule, there is no nesting at all.\n' );
  fprintf ( 1, '\n' );
  fprintf ( 1, '   DIM: ' );
