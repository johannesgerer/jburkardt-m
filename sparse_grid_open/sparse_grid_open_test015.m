function sparse_grid_test015 ( dim_min, dim_max, level_max_min, ...
  level_max_max )
...
%
  fprintf ( 1, '\n' );
  fprintf ( 1, 'TEST015\n' );
  fprintf ( 1, '  SPARSE_GRID_GPS_SIZE returns the number of\n' );
  fprintf ( 1, '  distinct points in a sparse grid made up of all \n' );
  fprintf ( 1, '  product grids formed from Gauss Patterson Slow \n' );
