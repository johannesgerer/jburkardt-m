...
%    @quad_fun indicates the function we want to execute;
%    {} would contain input arguments if there were any.
%
%    The function "quad_fun" must correspond to a MATLAB M-file "quad_fun.m"
...
%    John Burkardt
%
  fsuClusterMatlab ( [], [], 'p', 'w', 4, @quad_fun, { 100000 } )
