function hex_grid_angle_write ( box, center, angle, h, n, r, file_out_name )
...
%  Parameters:
%
%    Input, real BOX(2,2), the lower left and upper right
%    corners of the box.
%
...
%
  ...
  if ( file_out_unit < 0 )
    fprintf ( 1, '\n' );
    fprintf ( 1, 'HEX_GRID_ANGLE_WRITE - Fatal error!\n' );
    fprintf ( 1, '  Could not open the output file:\n' );
    fprintf ( 1, '  "%s".\n', file_out_name );
    error ( 'HEX_GRID_ANGLE_WRITE - Fatal error!' );
  end

  fprintf ( file_out_unit, '#  %s\n', file_out_name );
  fprintf ( file_out_unit, '#  created by HEX_GRID_ANGLE_WRITE.M\n' );
  fprintf ( file_out_unit, '#\n' );
  fprintf ( file_out_unit, '#  DIM_NUM = %d\n', dim_num );
  fprintf ( file_out_unit, '#  N =       %d\n', n );
  fprintf ( file_out_unit, '#  BOX_LO =  %f  %f\n', box(1:dim_num,1) );
  fprintf ( file_out_unit, '#  BOX_HI =  %f  %f\n', box(1:dim_num,2) );
