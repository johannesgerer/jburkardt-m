...
%*****************************************************************************80
%
%% FACT_TEST tests the use of the MEX file FACT.CPP
%
%  Discussion:
%
%    The file fact.cpp is a C++ function which computes the factorial.
%
%    This M file "compiles" fact.cpp, and then shows how it can be called.
%
%  Licensing:
%
...
%
  ...
  fprintf ( 1, '\n' );
  fprintf ( 1, '  Get a directory listing.  The file FACT.CPP should be there.\n' );

  ls
  
  fprintf ( 1, '\n' );
  fprintf ( 1, '  Compile the file FACT.CPP.\n' );
