function msm_to_mm_coordinate_integer_general ( output_filename, a ) 

%*****************************************************************************80
%
%% MSM_TO_MM_COORDINATE_INTEGER_GENERAL writes a "matrix coordinate integer general" Matrix Market file.
%
%  Licensing:
%
...
%
  ...
  if ( fid < 0 ); 
    fprintf ( 1, '\n' );
    fprintf ( 1, 'MSM_TO_MM_COORDINATE_INTEGER_GENERAL - Fatal error!\n' );
    fprintf ( 1, '  Cannot open the output file.\n' );
    error ( 'MSM_TO_MM_COORDINATE_INTEGER_GENERAL - Fatal error!'); 
  end;

  fprintf ( fid, '%%%%MatrixMarket matrix coordinate integer general\n');
  fprintf ( fid, '%%%%  Created by MSM_TO_MM_COORDINATE_INTEGER_GENERAL.M\n' );
  fprintf ( fid, '  %d  %d  %d\n', nrow, ncol, nnzeros );
