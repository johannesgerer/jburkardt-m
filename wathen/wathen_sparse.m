function [ a, seed ] = wathen_sparse ( nx, ny, n, seed )

%*****************************************************************************80
%
%% WATHEN_SPARSE returns the Wathen matrix, using sparse storage.
%
%  Discussion:
%
...
%
  if ( nargin < 1 )
    fprintf ( 1, '\n' );
    fprintf ( 1, 'WATHEN_SPARSE - Fatal error!\n' );
    fprintf ( 1, '  Not enough input.\n' );
    error ( 'WATHEN_SPARSE - Fatal error!' );
  end
