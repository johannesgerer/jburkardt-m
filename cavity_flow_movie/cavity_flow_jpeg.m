function cavity_flow_jpeg ( )

%*****************************************************************************80
%
%% CAVITY_FLOW_JPEG makes JPEG image files from flow data.
%
%  Discussion:
%
...
%    JPEG file, presumably so the JPEG files can be gathered into an
%    animation.
%
...
%
%    The MATLAB quiver routine internally scales the arrows, but this
...
%  a JPEG file.  Doing this was surprisingly complicated, and the help
%  system was not very clear.  Surely there's a more straightforward way!
%
    F = getframe;
    [X,map] = frame2im ( F );
    imwrite ( X, jpgfile, 'JPEG' );
