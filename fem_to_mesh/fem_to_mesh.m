...
%
  ...
  fprintf ( 1, '\n' );
  fprintf ( 1, 'FEM_TO_MESH\n' );
  fprintf ( 1, '  MATLAB version.\n' );
  fprintf ( 1, '\n' );
  fprintf ( 1, '  Read a set of FEM files;\n' );
  fprintf ( 1, '  Write a corresponding MESH file.\n' );
%
...
%
  fem_to_mesh_handle ( node_filename, element_filename, ...
...
function fem_to_mesh_handle ( node_filename, element_filename, ...
  boundary_node_mask_filename, mesh_filename )
...
%
%    Input, string MESH_FILENAME, the MESH filename.
%
  fprintf ( 1, '\n' );
...
%
  ...
  mesh_write ( mesh_filename, dim, vertices, edges, triangles, ...
