function fem2d_mesh_display ( prefix, node_show, element_show )

%*****************************************************************************80
%
%% FEM2D_MESH_DISPLAY displays a mesh.
%
%  Discussion:
%
%    FEM_DISPLAY displays the nodes and elements of a mesh on the 
%    MATLAB graphics screen.
%
%  Usage:
%
%    fem2d_mesh_display prefix node_show element_show
%
%    where:
%
...
%
  ...
  fprintf ( 1, '\n' );
  fprintf ( 1, 'FEM2D_MESH_DISPLAY\n' );
  fprintf ( 1, '  MATLAB version\n' );
  fprintf ( 1, '\n' );
  fprintf ( 1, '  Read a node dataset of NODE_NUM points in 2 dimensions.\n' );
  fprintf ( 1, '  Read an associated element dataset of ELEMENT_NUM\n' );
...
%
  if ( nargin < 3 )
    ...
    fprintf ( 1, '  0: do not show the telements;\n' );
...
%  Display a plot.
%
  fem2d_mesh_display_matlab ( prefix, node_num, node_xy, element_order, ...
...
function fem2d_mesh_display_matlab ( prefix, node_num, node_xy, ...
  element_order, element_num, element_node, node_show, element_show )

%*****************************************************************************80
%
%% FEM2D_MESH_DISPLAY_MATLAB displays a mesh.
%
%  Licensing:
%
%    This code is distributed under the GNU LGPL license.
...
%
  if ( 2 <= element_show )
    ...
    for element = 1 : element_num
      p = element_node(1:element_order,element);
...
%
  if ( 1 <= element_show )
    ...
    for element = 1 : element_num
      p = [ element_node(1:element_order,element)', element_node(1,element) ];
...
%
%    Thanks to Mark Asch for pointing out an error, 01 December 2009!
%
%  Licensing:
%
%    This code is distributed under the GNU LGPL license. 
