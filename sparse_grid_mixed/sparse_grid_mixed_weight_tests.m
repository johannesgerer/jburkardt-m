function sparse_grid_mixed_weight_tests ( )

%*****************************************************************************80
%
%% SPARSE_GRID_MIXED_WEIGHT_TESTS calls SPARSE_GRID_MIXED_WEIGHT_TEST with various arguments.
%
%  Licensing:
%
...
%
  ...
  timestamp ( );
  fprintf ( 1, '\n' );
  fprintf ( 1, 'SPARSE_GRID_MIXED_WEIGHT_TESTS\n' );
  fprintf ( 1, '  MATLAB version\n' );
  fprintf ( 1, '  Call SPARSE_GRID_MIXED_WEIGHT with various arguments.\n' );
  ...
  alpha = [ 0.0, 0.0 ]';
  beta = [ 0.0, 0.0 ]';
  sparse_grid_mixed_weight_test ( dim_num, level_max_min, level_max_max, ...
    rule, alpha, beta, tol );
