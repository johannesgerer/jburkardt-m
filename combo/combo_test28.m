function combo_test28 ( )

%*****************************************************************************80
%
%% COMBO_TEST28 tests PERM_ENUM, _LEX_RANK, _LEX_SUCCESSOR, _LEX_UNRANK.
%
%  Licensing:
%
...
%
  ...
  fprintf ( 1, '\n' );
  fprintf ( 1, 'COMBO_TEST28\n' );
  fprintf ( 1, '  Permutations of the integers,\n' );
  fprintf ( 1, '  using the lexicographic ordering:\n' );
  fprintf ( 1, '\n' );
  fprintf ( 1, '  PERM_ENUM enumerates,\n' );
  fprintf ( 1, '  PERM_LEX_RANK ranks,\n' );
  fprintf ( 1, '  PERM_LEX_SUCCESSOR lists,\n' );
  fprintf ( 1, '  PERM_LEX_UNRANK unranks.\n' );
%
%  Enumerate.
%
  nperm = perm_enum ( n );
