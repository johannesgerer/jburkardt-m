function condition_test03 ( )

%*****************************************************************************80
%
%% CONDITION_TEST03 tests CONDITION_HAGER.
%
%  Licensing:
%
...
%
  fprintf ( 1, '\n' );
  fprintf ( 1, 'CONDITION_TEST03\n' );
  fprintf ( 1, '  For a matrix in general storage,\n' );
  fprintf ( 1, '  CONDITION_HAGER estimates the L1 condition number.\n' );
  fprintf ( 1, '\n' );
  fprintf ( 1, '  Matrix               Order   Condition         Hager\n' );
  fprintf ( 1, '\n' );
%
