function fe2d_nd_fast_test ( )

%*****************************************************************************80
%
%% FE2D_ND_FAST_TEST tests the FE2D_ND_FAST code.
%
%  Discussion:
%
%    This function sets all parameter values and initial condition information
%    necessary to execute the "fast" version of the fe2d_nd algorithm.
%
%  Licensing:
%
...
%
  ...
  fprintf ( 1, '  Test the FE2D_ND_FAST function, which\n' );
...
% T = 150.0;
  ...
  t = tic;
  fe2d_nd_fast ( alpha, beta, gamma, delta, T, delt, @u0f, @v0f, @g1uf, ...
    @g1vf, @g2uf, @g2vf );
  t = toc ( t );
