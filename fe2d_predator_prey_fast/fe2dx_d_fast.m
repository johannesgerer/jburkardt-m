function fe2dx_d_fast ( alpha, beta, gamma, delta, T, delt, u0f, v0f, guf, gvf )

%*****************************************************************************80
%
%% FE2DX_D_FAST applies Scheme 1 with Kinetics 1 to predator prey in a region.
%
%  Discussion:
%
%    FE2DX_D_FAST is a "fast" version of FE2DX_D.
%
%    FE2DX_D is a finite element Matlab code for Scheme 1 applied 
...
%
%  Adjust A0 and C0 for Dirichlet boundary conditions on Gamma
%
  for i = 1:isn
    node = bn(i);
    C(node,:) = 0; 
...
%
%  Impose Dirichlet boundary conditions on Gamma, and zero out
%  entries of DIAG and DIAG_ENTRIES that would interfere.
%
    for i = 1 : isn
      node = bn(i);
      xx = p(1,node);
...
%
%  Do the incomplete LU factorisation of A and C.
%
...
%
    [v,flagv,relresv,iterv] = gmres ( C, v,[],1e-6,[],LC,UC,v );
