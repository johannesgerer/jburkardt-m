function fe2dx_d_fast_test ( )

%*****************************************************************************80
%
%% FE2DX_D_FAST_TEST tests the FE2DX_D_FAST code.
%
%  Discussion:
%
%    This function sets all parameter values and initial condition information
%    necessary to execute the "fast" version of the fe2dx_d algorithm.
%
%  Licensing:
%
...
%
  timestamp ( );
  fprintf ( 1, '\n' );
  fprintf ( 1, 'FE2DX_D_FAST_TEST:\n' );
  fprintf ( 1, '  Test the FE2DX_D_FAST function\n' );
...
% T = 150.0;
  ...
  t = tic;
  fe2dx_d_fast ( alpha, beta, gamma, delta, T, delt, @u0f, @v0f, @guf, @gvf );
  t = toc ( t );
