function [x, steps, relres] = jacobi( A, b, n, tol, maxit, x0 )

%% JACOBI solves the (square) system of linear equations A*x = b
%
%  Discussion:
%
%    This is the standard Jacobi iterative method. 
%    Recall that in the standard Jacobi method we iterate via
%
%    x_(k+1) = inv(D)*((-L-U)*x_k + b), k = 0, 1, 2, ...
%
