function fe2dx_p_fast_test ( )

%*****************************************************************************80
%
%% FE2DX_P_FAST_TEST tests the FE2DX_P_FAST code.
%
%  Discussion:
%
%    This function sets all parameter values and initial condition information
%    necessary to execute the "fast" version of the fe2dx_p algorithm.
%
%  Licensing:
%
...
%
  timestamp ( );
  fprintf ( 1, '\n' );
  fprintf ( 1, 'FE2DX_P_FAST_TEST:\n' );
  fprintf ( 1, '  Test the FE2DX_P_FAST function\n' );
...
% T = 150.0;
  ...
  t = tic;
  fe2dx_p_fast ( alpha, beta, gamma, delta, a, b, h, T, delt, @u0f, @v0f );
  t = toc ( t );
