...
%
  ...
  fprintf ( 1, '\n' );
  fprintf ( 1, 'R8MAT_DET_3D_TEST\n' );
  fprintf ( 1, '  R8MAT_DET_3D: determinant of a 3 by 3 matrix;\n' );
  ...
  fprintf ( 1, '\n' );
  fprintf ( 1, '  R8MAT_DET_3D computes determinant: %f\n', det );
%
