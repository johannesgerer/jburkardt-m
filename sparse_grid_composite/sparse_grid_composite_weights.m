function grid_weight = sparse_grid_composite_weights ( dim_num, level_max, ...
  point_num, grid_index )

%*****************************************************************************80
%
%% SPARSE_GRID_COMPOSITE_WEIGHTS gathers the weights.
%
%  Licensing:
%
...
%
      grid_weight2 = product_weights_composite ( dim_num, order_1d, order_nd );
%
