function sparse_grid_composite_test02 ( dim_num, level_max )
 
%*****************************************************************************80
%
%% SPARSE_GRID_COMPOSITE_TEST02 tests SPARSE_GRID_COMPOSITE_INDEX.
%
%  Discussion:
%
...
%
  fprintf ( 1, '\n' );
  fprintf ( 1, 'SPARSE_GRID_COMPOSITE_TEST02:\n' );
  fprintf ( 1, '  SPARSE_GRID_COMPOSITE_INDEX returns all grid indexes\n' );
