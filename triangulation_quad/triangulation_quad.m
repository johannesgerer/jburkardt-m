...
%
%    Local, integer ELEMENT_NUM, the number of triangles.
%
%    Local, integer ELEMENT_ORDER, the order of the triangles, 
%    either 3 or 6.
%
...
%
%    Local, real NODE_XY(NODE_DIM,NODE_NUM), the nodes of the triangulation.
%
