function tanh_quad_test05 ( p )

%*****************************************************************************80
%
%% TANH_QUAD_TEST05 applies a sequence of tanh rules to a test integral.
%
%  Licensing:
%
...
%
  fprintf ( 1, '\n' );
  fprintf ( 1, 'TANH_QUAD_TEST05\n' );
  fprintf ( 1, '  Apply a sequence of tanh rules to a test integral.\n' );
