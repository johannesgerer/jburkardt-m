function tanh_quad_test06 ( p )

%*****************************************************************************80
%
%% TANH_QUAD_TEST06 applies a sequence of tanh-sinh rules to a test integral.
%
%  Licensing:
%
...
%
  fprintf ( 1, '\n' );
  fprintf ( 1, 'TANH_QUAD_TEST06\n' );
  fprintf ( 1, '  Apply a sequence of tanh-sinh rules to a test integral.\n' );
