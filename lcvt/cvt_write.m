function cvt_fprintf ( dim_num, n, seed_start, sample_function_init, ...
...
%    -1, the initialization function is RAND (MATLAB intrinsic),
...
%    -1, the sampling function is RAN (MATLAB intrinsic),
