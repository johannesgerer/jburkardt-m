function x = r83_cr_sls ( n, a_cr, nb, b )
...
%
%    Input, real B(N,NB), the right hand side vectors.
%
%    Output, real X(N,NB), the solutions of the linear system.
%
  if ( n <= 0 )
    fprintf ( 1, '\n' );
    fprintf ( 1, 'R83_CR_SLS - Fatal error!\n' );
