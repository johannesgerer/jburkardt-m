function xy_display ( xy_filename )

%*****************************************************************************80
%
%% XY_DISPLAY plots a set of points in 2D.
%
%  Licensing:
%
...
%  Parameters:
%
%    Input, string XY_FILENAME, the name of the file 
...
%
  if ( nargin < 1 )
    fprintf ( 1, '\n' );
    fprintf ( 1, 'XY_DISPLAY:\n' );
    xy_filename = input ( '  Enter the name of the point file (in ''quotes''!).\n' );
  end
%
%  Read the data.
%
  ...
  r8mat_transpose_print_some ( 2, point_num, xy, 1, 1, ...
    2, 5, '  First 5 nodes:' );
...
%
  title_string = s_escape_tex ( xy_filename );
  title ( title_string )
