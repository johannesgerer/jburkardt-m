function beta_noncentral_cdf_values_test ( )

%*****************************************************************************80
%
%% BETA_NONCENTRAL_CDF_VALUES_TEST demonstrates the use of BETA_NONCENTRAL_CDF_VALUES.
%
%  Licensing:
%
...
%
  fprintf ( 1, '\n' );
  fprintf ( 1, 'BETA_NONCENTRAL_CDF_VALUES_TEST:\n' );
