...
%    * 'prefix'_l2q_nodes.txt contains the new node coordinates;
%    * 'prefix'_l2q_elements.txt contains the new element definitions;
%
%  Licensing:
%
...
%
  ...
  fprintf ( 1, '\n' );
  fprintf ( 1, 'TET_MESH_L2Q:\n' );
  fprintf ( 1, '  MATLAB version:\n' );
  fprintf ( 1, '  Read a "linear" tet mesh and\n' );
...
%
  ...
  output_node_filename = strcat ( prefix, '_l2q_nodes.txt' );
  output_element_filename = strcat ( prefix, '_l2q_elements.txt' );
%
%  Read the node data.
%
...
%
  ...
  if ( tetra_order1 ~= 4 )
    ...
    error ( 'TET_MESH_L2Q - Fatal error!' );
  end
