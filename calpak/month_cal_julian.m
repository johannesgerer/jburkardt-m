...
%
  ...
  w = ymdf_to_weekday_julian ( y2, m2, d, f );
%
...
%
  while ( iday <= month_length_julian ( y2, m2 ) )
    ...
    for w = 1 : 7
      ...
      if ( iday < 1 )
        fprintf ( 1, '   ' );
      elseif ( month_length_julian ( y2, m2 ) < iday )
        fprintf ( 1, '   ' );
      else
        fprintf ( 1, ' %2d', iday );
      end
