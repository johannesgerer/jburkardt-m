function calpak_test020 ( )

%*****************************************************************************80
%
%% CALPAK_TEST020 tests JED_TO_YMDF_GREGORIAN and YMDF_TO_JED_GREGORIAN.
%
%  Licensing:
%
...
%
  fprintf ( 1, '\n' );
  fprintf ( 1, 'CALPAK_TEST020\n' );
  fprintf ( 1, '  For the Gregorian calendar:\n' );
  fprintf ( 1, '  JED_TO_YMDF_GREGORIAN: JED -> YMDF.\n' );
  ...
  while ( 1 )
    ...
    [ y2, m2, d2, f2 ] = jed_to_ymdf_gregorian ( jed1 );
