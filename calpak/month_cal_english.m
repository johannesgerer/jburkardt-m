function month_cal_english ( y, m )
...
%
  ...
  w = ymdf_to_weekday_english ( y2, m2, d, f );
%
...
%
  ...
  fprintf ( 1, '\n' );
  fprintf ( 1, 'ENGLISH CALENDAR\n' );
  s2 = y_to_s_english ( y2 );
  fprintf ( 1, '%s %s\n', s1, s2 );
  fprintf ( 1, '\n' );
%
...
%
  ...
  while ( iday <= d_max )
    ...
    for w = 1 : 7
      ...
      [ y2, m2, d2, f2 ] = ymdf_next_english ( y2, m2, d2, f2 );
