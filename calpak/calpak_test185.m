function calpak_test185 ( )

%*****************************************************************************80
%
%% CALPAK_TEST185 tests JED_TO_YMDF_ISLAMIC_A and YMDF_TO_JED_ISLAMIC_A2.
%
%  Licensing:
%
...
%
  ...
  while ( 1 )
    ...
    if ( jed_epoch <= jed1 )
      ...
      jed3 = ymdf_to_jed_islamic_a2 ( y2, m2, d2, f2 );
