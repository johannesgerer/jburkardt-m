function mesh_display ( prefix, node_show, element_show )

%*****************************************************************************80
%
%% MESH_DISPLAY displays a mesh.
%
%  Discussion:
%
%    MESH_DISPLAY displays the nodes and elements of a mesh on the 
%    MATLAB graphics screen.
%
%  Usage:
%
%    mesh_display prefix node_show element_show
%
%    where:
%
...
%  Display a plot.
%
  mesh_display_matlab ( prefix, node_num, node_xy, element_order, ...
...
function mesh_display_matlab ( prefix, node_num, node_xy, element_order, ...
  element_num, element_node, node_show, element_show )

%*****************************************************************************80
%
%% MESH_DISPLAY_MATLAB displays a mesh.
%
%  Licensing:
%
%    This code is distributed under the GNU LGPL license.
...
%
  ...
  if ( 1 <= node_show )
    plot ( node_xy(1,:), node_xy(2,:), 'o', 'markersize', 4, 'markerfacecolor', 'black' );
  end
%
%  Label the nodes.
%
