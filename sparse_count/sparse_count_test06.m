function sparse_count_test06 ( dim_min, dim_max, level_max_min, ...
  level_max_max )

%*****************************************************************************80
%
%% SPARSE_COUNT_TEST06 tests ONN_E_SIZE.
%
%  Licensing:
%
...
%
  fprintf ( 1, '\n' );
  fprintf ( 1, 'SPARSE_COUNT_TEST06\n' );
  fprintf ( 1, '  ONN_E_SIZE returns the number of\n' );
