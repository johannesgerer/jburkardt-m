function calendar_nyt_test03 ( )

%*****************************************************************************80
%
%% CALENDAR_NYT_TEST03 tests JED_TO_NYT.
%
%  Discussion:
%
%    The routine JED_TO_NYT has been checked against the somewhat
%    erratic printing history of the New York Times in the 19th century.
%    This function seems to be delivering the correct answer for the
%    dates we have checked.
%
%    The "inverse" function NYT_TO_JED has not been written to handle th
%    nightmare of the 19th century issue numbering, however.
%
%  Volume  Issue   D M         Y
%  ------  -----  -- --------- ----
...
%
  ...
  for test = 1 : test_num
    ...
    fprintf ( 1, '\n' );
    fprintf ( 1, '  %11.2f  %25s  %8d  %8d\n', jed, s, volume1, issue1 );
    fprintf ( 1, '                                          %8d  %8d\n',         volume2, issue2 );
    fprintf ( 1, '                                          %8d  %8d\n',         volume2 - volume1, issue2 - issue1 );
