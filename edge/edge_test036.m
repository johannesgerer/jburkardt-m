function figure_num = edge_test036 ( figure_num )

%*****************************************************************************80
%
%% EDGE_TEST036 plots a function with a derivative discontinuity.
%
%  Discussion:
%
...
%
  ...
  fprintf ( 1, '\n' );
  fprintf ( 1, 'EDGE_TEST036:\n' );
  fprintf ( 1, '  Plot 2D test function #4, discontinuous medium wave, P(x,t).\n' );
