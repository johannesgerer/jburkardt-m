function sphere_llq_grid_display_test ( )
...
%
  ...
  fprintf ( 1, '\n' );
  fprintf ( 1, 'SPHERE_LLQ_GRID_DISPLAY_TEST\n' );
  fprintf ( 1, '  SPHERE_LLQ_GRID_DISPLAY displays an LLQ grid on a sphere.\n' );
  fprintf ( 1, '\n' );
...
%
  ...
  sphere_llq_grid_display ( r, pc, lat_num, long_num, node_num, node_xyz, line_num, ...
    line_data, filename );
