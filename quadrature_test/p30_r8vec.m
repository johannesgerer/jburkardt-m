function value = p30_r8vec ( action, name, dim_num, value )
...
%
  ...
  elseif ( action == 'G' | action == 'g' )
    ...
    elseif ( name == 'Z' | name == 'z' )
      ...
      fprintf ( 1, '\n' );
      fprintf ( 1, 'P30_R8VEC - Fatal error!\n' );
      fprintf ( 1, '  Unrecognized name = "%s".\n', name );
      error ( 'P30_R8VEC - Fatal error!' );
    end
  ...
  elseif ( action == 'R' | action == 'r' )
    ...
    if ( name == 'C' | name == 'c' )
      c = rand ( 1, dim_num );
      c(1:dim_num) = c(1:dim_num) * sqrt ( 140.0 / sqrt ( dim_num^3 ) ) ...
        / sqrt ( 170.0 );
      value(1:dim_num) = c(1:dim_num);
    elseif ( name == 'Z' | name == 'z' )
      z = rand ( 1, dim_num );
