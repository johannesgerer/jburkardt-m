function gis_test ( filename )

%*****************************************************************************80
%
%% GIS_TEST reads a GLIMMER GIS data file and prints it out.
%
%  Discussion:
%
...
%
  ...
  [ ndims, nvars, ngatts, unlimdimid, level_dim, time_dim, ...
    x0_dim, x1_dim, y0_dim, y1_dim, acab, artm, beta, bheatflx, temp, ...
    thk, time, topg, x0, x1, y0, y1 ] = gis_read ( filename );

  gis_header_print ( ndims, nvars, ngatts, unlimdimid, level_dim, time_dim, ...
    x0_dim, x1_dim, y0_dim, y1_dim, filename );

  if ( 0 )
    gis_data_print ( ndims, nvars, ngatts, unlimdimid, level_dim, time_dim, ...
      x0_dim, x1_dim, y0_dim, y1_dim, acab, artm, beta, bheatflx, temp, ...
