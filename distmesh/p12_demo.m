function p12_demo ( iteration_max, h )

%*****************************************************************************80
%
%% P12_DEMO runs the 2D demo problem #12, with mesh size H.
%
%  Licensing:
%
...
%
  ...
  fprintf ( 1, '  John Shadid''s H-shaped region, h = %f\n', h )
...
%
  ...
  triangulation_order3_plot ( 'p12_mesh.eps', node_num, p, tri_num, ...
    t, node_show, triangle_show );
%
%  Write a text file containing the nodes.
%
  r8mat_write ( 'p12_nodes.txt', 2, node_num, p );
%
%  Write a text file containing the triangles.
%
  i4mat_write ( 'p12_elements.txt', 3, tri_num, t );
