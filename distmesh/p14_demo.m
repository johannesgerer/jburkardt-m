function p14_demo ( iteration_max, h, fh )

%*****************************************************************************80
%
%% P14_DEMO runs the 2D demo problem #14, with mesh size H.
%
%  Licensing:
%
...
%
  ...
  triangulation_order3_plot ( 'p14_mesh.eps', node_num, p, tri_num, ...
    t, node_show, triangle_show );
%
%  Write a text file containing the nodes.
%
  r8mat_write ( 'p14_nodes.txt', 2, node_num, p );
%
%  Write a text file containing the triangles.
%
  i4mat_write ( 'p14_elements.txt', 3, tri_num, t );
