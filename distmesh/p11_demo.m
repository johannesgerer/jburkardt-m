function p11_demo ( iteration_max, h )

%*****************************************************************************80
%
%% P11_DEMO runs the 2D demo problem #11, with mesh size H.
%
%  Licensing:
%
...
%
  ...
  fprintf ( 1, '  The L-shaped region, h = %f\n', h )

  fd = @p11_fd;
  fh = @p11_fh;
  box = [ 0.0, 0.0; 1.0, 1.0 ];
  fixed = [ 0.0,0.0; 1.0,0.0; 1.0,0.5; 0.5,0.5; 0.5,1.0; 0.0,1.0 ];
...
%
  ...
  triangulation_order3_plot ( 'p11_mesh.eps', node_num, p, tri_num, ...
    t, node_show, triangle_show );
%
%  Write a text file containing the nodes.
%
  r8mat_write ( 'p11_nodes.txt', 2, node_num, p );
%
%  Write a text file containing the triangles.
%
  i4mat_write ( 'p11_elements.txt', 3, tri_num, t );
