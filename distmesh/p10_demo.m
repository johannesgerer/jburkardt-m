function p10_demo ( iteration_max, h )

%*****************************************************************************80
%
%% P10_DEMO runs the 2D demo problem #10, with mesh size H.
%
%  Licensing:
%
...
%
  ...
  triangulation_order3_plot ( 'p10_mesh.eps', node_num, p, tri_num, ...
    t, node_show, triangle_show );
%
%  Write a text file containing the nodes.
%
  r8mat_write ( 'p10_nodes.txt', 2, node_num, p );
%
%  Write a text file containing the triangles.
%
  i4mat_write ( 'p10_elements.txt', 3, tri_num, t );
