function p16_demo ( iteration_max, h )

%*****************************************************************************80
%
%% P16_DEMO runs the 2D demo problem #2, with mesh size H.
%
%  Discussion:
%
%   The P16 region is a quarter sector of a circular annulus.
%
%  Licensing:
%
...
%
  ...
  fprintf ( 1, '  Kevin Pond''s elbow (quarter circular annulus), h = %f\n', h )
...
%
  ...
  triangulation_order3_plot ( 'p16_mesh.eps', node_num, p, tri_num, ...
    t, node_show, triangle_show );
%
%  Write a text file containing the nodes.
%
  r8mat_write ( 'p16_nodes.txt', 2, node_num, p );
%
%  Write a text file containing the triangles.
%
  i4mat_write ( 'p16_elements.txt', 3, tri_num, t );
