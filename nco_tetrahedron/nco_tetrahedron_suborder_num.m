function suborder_num = nco_tetrahedron_suborder_num ( rule )
...
%
  ...
  elseif ( rule == 7 )
    ...
    suborder_num = -1;
    fprintf ( 1, '\n' );
    fprintf ( 1, 'NCO_TETRAHEDRON_SUBORDER_NUM - Fatal error!\n' );
    fprintf ( 1, '  Illegal RULE = %d\n', rule );
    error ( 'NCO_TETRAHEDRON_SUBORDER_NUM - Fatal error!\n' )
