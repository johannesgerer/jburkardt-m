function a = r8cc_set ( m, n, nz_num, colptr, rowind, a, i, j, aij )
...
%
%    Input, real AIJ, the new value of A(I,J).
%
%    Output, real A(NZ_NUM), the entry of A corresponding to (I,J)
%    has been reset.
%
...
%
  if ( k == -1 )
    fprintf ( 1, '\n' );
    fprintf ( 1, 'R8CC_SET - Fatal error!\n' );
    fprintf ( 1, '  R8CC_IJK could not find the entry.\n' );
    fprintf ( 1, '  Row I = %d\n', i );
    fprintf ( 1, '  Col J = %d\n', j );
    error ( 'R8CC_SET - Fatal error!' );
  end
