function int_exactness_chebyshev2 ( quad_filename, degree_max )
...
%
  timestamp ( );
  fprintf ( 1, '\n' );
  fprintf ( 1, 'INT_EXACTNESS_CHEBYSHEV2\n' );
  fprintf ( 1, '  MATLAB version\n' );
  fprintf ( 1, '\n' );
  fprintf ( 1, '  Investigate the polynomial exactness of a Gauss-Chebyshev1\n' );
  fprintf ( 1, '  type 2 quadrature rule by integrating all monomials up to a given\n' );
...
%
  fprintf ( 1, '\n' );
  fprintf ( 1, 'INT_EXACTNESS_CHEBYSHEV2: User input:\n' );
...
%
  ...
  fprintf ( 1, '  a Gauss-Chebyshev type 2 rule\n' );
  fprintf ( 1, '  ORDER = %d\n', order );
  fprintf ( 1, '\n' );
...
%
  fprintf ( 1, '\n' );
  fprintf ( 1, '  A Gauss-Chebyshev type 2 rule would be able to exactly\n' );
...
function quad_error = monomial_quadrature_chebyshev2 ( expon, order, w, x )

%*****************************************************************************80
%
%% MONOMIAL_QUADRATURE_CHEBYSHEV2 applies a quadrature rule to a monomial.
%
%  Licensing:
%
%    This code is distributed under the GNU LGPL license.
