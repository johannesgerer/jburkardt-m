%% CONTRAST2_BATCH_ITHACA uses the BATCH command to run the CONTRAST2 code on the Ithaca cluster.
%
%  Licensing:
%
...
%
  ...
  fprintf ( 1, '\n' );
  fprintf ( 1, 'CONTRAST2_BATCH_ITHACA\n' );
  fprintf ( 1, '  Run CONTRAST2_SCRIPT on Ithaca.\n' );
%
