%% CONTRAST2_FSU uses the fsuClusterMatlab command to run the CONTRAST2 computation.
%
%  Discussion:
%
...
%    @contrast2_fun indicates the function we want to execute;
%    {} would contain input arguments if there were any.
%
%    The function "contrast2_fun" must correspond to a MATLAB M-file "contrast2_fun.m"
...
%
  ...
  fsuClusterMatlab ( [], [], 'm', 'w', 4, @contrast2_fun, { x } )
