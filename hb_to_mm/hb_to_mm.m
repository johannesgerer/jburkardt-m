function hb_to_mmm ( input_file, output_file )

%*****************************************************************************80
%
%% HB_TO_MM transfers sparse matrix information from an HB file to an MM file.
%
%  Discussion:
%
%    An HB file is a sparse matrix stored in the Harwell Boeing format.
%
%    An MM file is a sparse matrix stored in the Matrix Market format.
%
%  Licensing:
%
...
%  Parameters:
%
%    Input, string INPUT_FILE, the name of the HB file to be read.
%
%    Input, string OUTPUT_FILE, the name of the MM file to be created.
%
  a = hb_to_msm ( input_file );

  msm_to_mm_coordinate_real_general ( output_file, a );
