...
%
  ...
  fprintf ( 1, '    A * X - B\n' );
  fprintf ( 1, '  given MxN matrix A, NxK solution X, MxK right hand side B.\n' );
  fprintf ( 1, '\n' );
  fprintf ( 1, '  Matrix title           M     N     K       ||A||            ||A*X-B||\n' );
  fprintf ( 1, '\n' );
%
%  BODEWIG matrix.
%
...
%
  ...
  b = poisson_rhs ( nrow, ncol, n, k );
  x = poisson_solution ( nrow, ncol, n, k );
  error_frobenius = r8mat_is_solution ( m, n, k, a, x, b );
  norm_frobenius = r8mat_norm_fro ( n, n, a );
  fprintf ( 1, '%20s  %4d  %4d  %4d  %14f  %14f\n', ...
    title, m, n, k, norm_frobenius, error_frobenius );
