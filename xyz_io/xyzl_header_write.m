function xyzl_header_write ( output_filename, output_unit, point_num, ...
  line_num, line_data_num )

%*****************************************************************************80
%
%% XYZL_HEADER_WRITE writes the header of an XYL file.
%
%  Licensing:
%
...
%
  ...
  fprintf ( output_unit, '#  created by xyz_io::xyzl_header_write.m\n' );
  fprintf ( output_unit, '#\n');
