function xyzl_write ( output_filename, point_num, line_num, line_data_num, ...
...
%
  ...
  if ( output_unit < 0 ) 
    fprintf ( 1, '\n' );
    fprintf ( 1, 'XYZL_WRITE - Error!\n' );
    fprintf ( 1, '  Could not open the output file "%s".\n', output_filename );
    error ( 'XYZL_WRITE - Error!' );
  end
%
%  Write the header.
%
...
%  Write the data.
%
  xyzl_data_write ( output_unit, point_num, line_num, line_data_num, ...
    line_pointer, line_data );
%
%  Close the file.
%
