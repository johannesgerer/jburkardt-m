function tcell_flow_display ( upfile )

%*****************************************************************************80
%
%% TCELL_FLOW_DISPLAY displays the flow field for a T-Cell snapshot.
%
%  Discussion:
%
...
%
  ...
  bx2 = [ 0.00, 0.25, 0.25, 0.75, 0.75, 1.00, 1.00, ...
          0.74, 0.74, 0.26, 0.26, 0.00, 0.00];
  by2 = [ 0.50, 0.50, 0.00, 0.00, 0.50, 0.50, 0.51, ...
          0.51, 0.01, 0.01, 0.51, 0.51, 0.50];
