...
% 
  ...
  fprintf ( 1, '  BICGSTAB uses the BiConjugate Gradient Stabilized\n' );
  ...
  [ x, error_norm, iter, flag ] = bicgstab ( A, x, b, M, max_it, tol );

  fprintf ( 1, '\n' );
  fprintf ( 1, '  The BICGSTAB routine has returned with FLAG = %d\n', flag );
  if ( flag == 0 )
