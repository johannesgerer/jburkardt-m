...
%*****************************************************************************80
%
%% BICG_TEST tests BICG.
% 
  fprintf ( 1, '\n' );
  fprintf ( 1, 'BICG_TEST:\n' );
  fprintf ( 1, '  BICG uses the BiConjugate Gradient Stabilized\n' );
  ...
  [ x, error_norm, iter, flag ] = bicg ( A, x, b, M, max_it, tol );

  fprintf ( 1, '\n' );
  fprintf ( 1, '  The BICG routine has returned with FLAG = %d\n', flag );
  if ( flag == 0 )
