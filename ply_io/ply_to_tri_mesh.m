function [ node_xyz, triangle_node ] = ply_to_tri_mesh ( ply_file_name )

%*****************************************************************************80
%
%% PLY_TO_TRI_MESH converts data from a PLY file to TRI_MESH data.
%
%  Discussion:
%
...
%    a pair of arrays that define a TRI_MESH, that is a triangular
...
%  Example:
%
%     [ node_xyz, triangle_node ] = ply_to_tri_mesh ( 'cow.ply' );
%
...
%  Parameters:
%
%    Input, string PLY_FILE_NAME, the name of the PLY file to be read.
%
...
%
  [ fid, Msg ] = fopen ( ply_file_name, 'rt' );
