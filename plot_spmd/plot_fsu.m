%% PLOT_FSU uses the fsuClusterMatlab command to run the PLOT computation.
%
%  Discussion:
%
...
%    @plot_fun indicates the function we want to execute;
%    {} would contain input arguments if there were any.
%
%    The function "plot_fun" must correspond to a MATLAB M-file "plot_fun.m"
...
%    John Burkardt
%
  fsuClusterMatlab ( [], [], 'm', 'w', 4, @plot_fun, { } )
